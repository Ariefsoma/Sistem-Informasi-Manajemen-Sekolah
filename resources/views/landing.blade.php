...
<div class="bg-white dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <div class="mt-8 flex justify-center gap-4">
            <a href="{{ route('register') }}" class="px-6 py-2 bg-blue-600 text-white rounded">Daftar</a>
            <a href="{{ route('login') }}" class="px-6 py-2 border border-gray-300 rounded">Masuk</a>
        </div>
    </div>
