                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    @auth
                        ...
                        @if ($role === 'admin' || Auth::user()->is_admin)
                            {{-- Admin Panel link removed by request; keep User Links if needed --}}
                            <x-nav-link :href="route('admin.user-links.index')" :active="request()->routeIs('admin.user-links.*')">
                                User Links
                            </x-nav-link>
                        @elseif ($role === 'guru')
                            <x-nav-link :href="route('dashboard')" :active="request()->is('guru/*')">
                                Guru Panel
                            </x-nav-link>
                        @elseif ($role === 'siswa')
